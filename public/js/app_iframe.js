...
var addTabs = function (options) {
    ...
    if (findTabPanel(pageId) === null) {
        ...
        if (options.content) {
            ...
            var $iframe = $("<iframe></iframe>").attr("scrolling", "no").css("overflow", "hidden").attr("src", options.url).css("width", "100%").attr("frameborder", "no").attr("id", "iframe_" + pageId).addClass("tab_iframe").attr(pageIdField, pageId);
