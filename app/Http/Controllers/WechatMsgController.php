...
class WechatMsgController extends Controller
{
    ...
    public function addArticle(Request $request)
    {
        ...
        $article = new Article([
            ...
            'author' => '秦瑞涵',
            'content' => html_entity_decode('<p style="margin-top: 0cm; margin-right: 0cm; margin-bottom: 0.0001pt; text-align: justify; font-size: 14px; font-family: Calibri, sans-serif;">
	<br>
</p>
...
'),
    ...
    {
        $app = $this->getWechat();
        $result = $app->broadcasting->sendNews($request->input('media_id'), explode(',', $request->input('openid')));
