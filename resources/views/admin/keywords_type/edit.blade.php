    ...
    <div class="box-body">
        <form action="{{route('admin.keywords_type.update',$type)}}" class="form-horizontal validate" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="key" id="inputKey" value="{{$type->key}}" data-rule-required="true" data-rule-remote="{{route('admin.keywords_type.check', ['ignore'=>$type->key])}}">
                </div>
            </div>
            <div class="form-group">
