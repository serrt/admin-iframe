...
<div class="row">
    <div class="col-md-3 col-xs-12">
        <a href="{{route('admin.wechat.index')}}" class="info-box bg-blue">
    ...
    <div class="col-md-3 col-xs-12">
        <a href="{{route('admin.wechat_users.index')}}" class="info-box bg-yellow">
    ...
    <div class="col-md-3 col-xs-12">
        <a href="{{route('admin.wechat_user_msg.index')}}" class="info-box bg-green">
