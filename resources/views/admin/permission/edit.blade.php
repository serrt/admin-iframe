        ...
        <div class="box-body">
            <form action="{{route('admin.permission.update', $permission)}}" class="form-horizontal validate" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="name" value="{{$permission->name}}" id="inputName" data-rule-required="true" data-rule-remote="{{route('api.web.permission', ['unique'=>'name', 'ignore'=>$permission->id])}}">
